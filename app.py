...
if uploaded_file:
    ...
    # Ajusta formato de AnoMes: Jan/25, Fev/25, etc.
    ...
    fig2 = px.bar(casos_origem, x="AnoMes", y="Total", color="Origem", text='Total')
    ...
    fig4 = px.bar(top_contas, x="Conta", y="Total", text='Total', title="Top 10 Contas com Mais Casos")
    ...
    fig5 = px.line(casos_resp, x="AnoMes", y="Total", color="Responsável", title="Casos por Responsável (Mensal)")
